...
function useReducedState(initialState) {
    var reducedState = useReducer(function (oldState, newState) { return (__assign(__assign({}, oldState), newState)); }, initialState);
    return reducedState;
}

var FirebaseContext = createContext(null);
var SIGNIN_PROVIDERS;
...
})(SIGNIN_PROVIDERS || (SIGNIN_PROVIDERS = {}));
function FirebaseAuthProvider(_a) {
    ...
    return (React.createElement(FirebaseContext.Provider, { value: {
            user: user,
            loading: loading,
            error: error,
            firebase: firebase,
...
export { FirebaseAuthProvider, SIGNIN_PROVIDERS, useFirebaseAuth };
