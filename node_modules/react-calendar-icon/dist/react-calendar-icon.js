(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('styled-components'), require('styled-jss')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'styled-components', 'styled-jss'], factory) :
	(global = global || self, factory(global.ReactCalendarIcon = {}, global.React, global.PropTypes, global.styled, global.styled));
}(this, (function (exports, React, PropTypes, styledComponents, styledJss) { 'use strict';

	React = React && React.hasOwnProperty('default') ? React['default'] : React;
	PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
	styledComponents = styledComponents && styledComponents.hasOwnProperty('default') ? styledComponents['default'] : styledComponents;
	styledJss = styledJss && styledJss.hasOwnProperty('default') ? styledJss['default'] : styledJss;
